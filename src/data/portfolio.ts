...
export const portfolioData = {
  personal: {
    ...
    summary:
      "6th-semester Informatics Engineering student at Universitas Padjadjaran, Bakti BCA Scholarship Awardee, and Maybank Intern Strategist. Builds data products across financial dashboards, machine learning, retail decision support, and automation.",
    currentThread:
  ...
  kpis: [
    { label: "Education", value: "UNPAD IF", detail: "Bachelor of Informatics Engineering" },
    { label: "Market Desk", value: "Maybank", detail: "Investment product strategy intern" },
    { label: "Language Edge", value: "JLPT N2", detail: "Japanese + English TOEFL 600" },
    { label: "Scholarship", value: "Bakti BCA", detail: "Merit-based awardee 2025" },
  ],
  experience: [
    {
      id: "MBK-01",
      title: "Intern Strategist",
      ...
      descriptions: [
        ...
        "Conducting market research and strategy formulation based on real-time economic data.",
      ],
    },
    {
      id: "MBK-02",
    ...
    },
    {
      ...
      company: "Dicoding Indonesia - DBS Coding Camp 2026",
      period: "Feb 2026 - Present",
      status: "TRAINING",
      side: "HOLD",
      media: [
  ...
  awards: [
    "Bakti BCA Scholarship Awardee 2025",
    "SPARK Student Ambassador 2025",
    "Maybank Student Ambassador 2024 & 2025",
    "2nd Place Japanese Language Olympiad DKI Jakarta 2022",
  ],
  skills: {
    Programming: ["Python", "C++", "Java", "JavaScript", "PHP", "SQL", "R", "Kotlin", "Dart"],
    "Data & AI": ["Scikit-learn", "Pandas", "NumPy", "NLTK", "LightGBM", "YOLO", "MediaPipe"],
    "Web & Tools": ["Laravel", "CodeIgniter4", "Oracle", "Git", "Figma", "Canva", "HTML/CSS"],
    Languages: ["Indonesian Native", "English TOEFL 600", "Japanese JLPT N2"],
  },
};
